<footer id="footer_trigger">
	...
	<?php if(!is_page_template('page-templates/template-contact.php') && (get_field('footer_layout_option', 'option') == "1-2 Locations")) { 
	
		get_template_part('page-templates/includes/template','locations');
	
	}
	 
	elseif(!is_page_template('page-templates/template-contact.php') && (get_field('footer_layout_option', 'option') == "4 Locations")) {
	...
	<div class="copyright">
		...
		<?php if(get_field('footer_layout_option', 'option') == "4 Locations"): ?>
