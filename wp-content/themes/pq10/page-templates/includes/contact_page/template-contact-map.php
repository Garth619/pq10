<div id="internal_main" class="no_banner">
	...
	<div id="contact_map_top">
		...
		<div class="contact_phone_wrapper">
			...
			<?php if(get_field('toll_free_title') && get_field('toll_free_phone')) { ?>
			...
			<?php if(get_field('main_location_title') && get_field('main_location_phone')) { ?>
...
window.eqfeed_callback = function(myJsonFile) {
    ...
    var contentString = '<div id="map_content">'+
      ...
      '</div>';
			...
			//var displayImg = '//'+mydomain+'/wp-content/themes/pq1/images/pin.png';

			var displayImg = '<?php echo $map_pin['url']; ?>';
